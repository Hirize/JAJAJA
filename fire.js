...
//Random raindrops falling vertically
...
for(i=0;i<225;i++){
  ...
  //Runs arrows on the screen for each arrow
  for(i=0;i<arrows.length;i++){
    //Prints the arrows on the screen
      ...
      //Moves arrow down updates Y position
      arrows[i][1]-=0.3;
      if(arrows[i][1]<-7){
        arrows.splice(i,1);
        points++;
      ...
      //Checks if raindrops hits player then ends game
